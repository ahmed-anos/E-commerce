    ...
    <div class="shop-list flex-grow-1">
      ...
      <div class="d-flex justify-content-between mb-4 pb-md-2">
        <div class="breadcrumb mb-0 d-none d-md-block flex-grow-1">
          ...
          <a href="#" class="menu-link menu-link_us-s text-uppercase fw-medium">{{ __('front.Shop') }}</a>
        </div>
        ...
        <div class="shop-acs d-flex align-items-center justify-content-between justify-content-md-end flex-grow-1">
          ...
          <div class="col-size align-items-center order-1 d-none d-lg-flex">
            <span class="text-uppercase fw-medium me-2">{{ __('front.view') }}</span>
          ...
          <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              ...
              <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                <div class="swiper-wrapper">
                  @foreach($product->images as $image)
                      <div class="swiper-slide">
                          <a href="details.html">
                              <img loading="lazy" src="{{ asset('storage/' . $image) }}" width="330" height="400" alt="Cropped Faux leather Jacket" class="pc__img">
                          </a>
            ...
            <div class="pc__info position-relative">
              ...
              <div class="product-card__price d-flex">
                <span class="money price">{{ $product->price }} {{ __('front.currency') }}</span>
              </div>
      ...
      <div class="text-center mt-2">
        <button wire:click="loadMore" class="btn-link btn-link_lg default-underline text-uppercase fw-medium" >{{ __('front.more') }}</button>
      </div>
    </div>
  </section>
</main>
